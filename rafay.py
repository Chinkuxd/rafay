...
\033[1;34;40m-----------------------------------------------
\033[1;32;40m.    THE UNBEATABLE BOY RAFAY INSIDE
\033[1;32;40m     MOUNTAIN DEW :-) HATERS KI MKC 3:)
\033[1;34;40m-----------------------------------------------"""
...
def sendtextconvo(comment):
    ...
    print (e.strftime("CHALA GAYA APKA MSG :: Date - %d/%m/%Y  Time - %I:%M:%S %p"))
    print(">> JA K SO JAO TATAY KI MAA CHUDTI RAHEGI :: ", line, "\n")
